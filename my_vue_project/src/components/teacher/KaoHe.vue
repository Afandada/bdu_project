 ...
 <img width="50px" height="60px"  :src="imggg">
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
        <el-button @click="dialogg(scope.row) " type="text" size="small">详情</el-button>
...
<el-drawer
  ...
  <div class="demo-drawer__content">
     <el-form :model="tableData">
      ...
      <el-form-item label="作业要求" :label-width="formLabelWidth">
        <el-input :disabled="true" autosize  v-model="tableData.zyyaoqiu" type="textarea" autocomplete="off"></el-input>
      </el-form-item>
    </el-form>
...
import db from '@/components/localstorage'
 ...
 handleAvatarSuccess(res, file) {
   ...
   const cc=db.get('edit',cc);
      ...
      //调用ajax
      var url = "http://localhost:8888/schoolms/kaohe/getkaohess";
      var locjrili = {
    ...
    //删除方法
      deletecourse(file) {
         ...
         var self = this;
      //调用ajax
      var url = "http://localhost:8888/schoolms/kaohe/delete";
      var score = {
       file:file
      };
   ...
   updatescore(file) {
      ...
      var url = "http://localhost:8888/schoolms/kaohe/update";
      var locscore = {
       file:file,
