...
<h3>个人基本资料</h3>
  <div>   
    ...
    align=center
      ...
      <el-table-column placeholder="用户名" prop="username" label="用户名" width="160" align=center> </el-table-column>
      ...
      <el-table-column placeholder="部门" prop="department" label="部门" width="160" align=center> </el-table-column>
